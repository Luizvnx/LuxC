                    ...
                    <div className="mx-auto max-w-8xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                <button
                                    type="button"
                                    className="flex rounded-full text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                                >
                                    <span className="sr-only">Your Shopping Cart</span>
                                    <ShoppingCartIcon className="h-8 w-8" aria-hidden="true" />
                                    <a className='flex text-xs rounded-full px-2 py-1 text-sm font-medium text-white bg-yellow-600 sm:ml-2 '>0</a>
                                </button>
                                    ...
                                    <div>
                                        <Menu.Button className="flex rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                            ...
                                            <img
                                                ...
                                                alt=""
                                            />
                                            <a className='rounded-md px-3 py-2 text-xs font-medium text-white '>Sign In</a>
                                        </Menu.Button>
                                    </div>
                                    <Transition
                                        as={Fragment}
